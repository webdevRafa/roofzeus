# RoofZeus brand v7 — approved September 13, 2026

The public navbar, footer, browser icons and organization metadata now use this identity. The earlier v6 artwork remains in the parent directory.

- `logo-light.svg`: navy/gold lockup for white backgrounds.
- `logo-dark.svg`: ivory/gold lockup for navy backgrounds.
- `emblem.svg`: Zeus/roof symbol.
- `favicon.svg`: white symbol on a gold tile.
- PNG, lossless WebP, multi-resolution ICO and touch-icon exports are included.
