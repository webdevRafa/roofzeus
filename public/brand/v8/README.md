# RoofZeus v8 — original concept proportions

The primary logo was traced as one composition directly from the original approved concept board. Zeus extends above and below the wordmark, and the roof reaches over the R. No independent scaling, bottom alignment or horizontal repositioning of the emblem or letters is applied.

- logo-light.svg: original primary composition, 1420 × 500.
- logo-dark.svg: original reversed composition from the same board, 686 × 230.
