...
const settings = (patch = {}) => readSettings(JSON.stringify({
  ...
  consentText: 'TEST FIXTURE ONLY. I consent to contact from Example Test Advertiser. This is not approved production consent.',
  consentAdvertiserName: 'Example Test Advertiser', singleAdvertiserConsentApproved: true,
